...
public class ArbitraryTimelineTest {
  ...
  public void twoEvents() {
    ...
    assertEquals(new Velocity(1, -1).gamma() * 10, timeline.timeElapsed(30, 40), 0.001);
    assertEquals(new Velocity(1, -1).gamma() * 5, timeline.timeElapsed(31, 36), 0.001);
  ...
  public void twoEvents_backwardsInTime() {
    ...
    assertEquals(new Velocity(-1, 2).gamma() * -10, timeline.timeElapsed(40, 30), 0.001);
    assertEquals(new Velocity(-1, 2).gamma() * -5, timeline.timeElapsed(37, 32), 0.001);
  ...
  public void threeEvents() {
    ...
    assertEquals(new Velocity(1, -2).gamma() * 5 + new Velocity(-2, 1).gamma() * 2,
        timeline.timeElapsed(5, 12), 0.01);
    assertEquals(new Velocity(1, -2).gamma() * 5 + new Velocity(-2, 1).gamma() * 5,
        timeline.timeElapsed(5, 15), 0.01);
    assertEquals(new Velocity(1, -2).gamma() * 10 + new Velocity(-2, 1).gamma() * 5,
